    ...
    <main class="pt-5 pb-3 mx-lg-3">
        <div class="container-fluid mt-5 mb-5 pt-2">
            <section class="page-header">
                <div class="row mt-n3">
                    <div class="col-md-7">
                        <h5 class="font-weight-bolder border-bottom text-left p-2 fadeInLeft animated">
                            <span class="text-primary">
                                <i class="fas fa-home"> </i> <?= isset($page_name) ? $page_name : ''; ?></span>
                        </h5>
                    </div>
                    <div class="col-md-5 text-center">
                        ...
                        <!-- Breadcrumb -->
                        <button id="jam" class="btn btn-sm waves-effect waves-light text-primary fadeInRight animated"></button>
                    </div>
