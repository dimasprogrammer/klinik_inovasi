                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" class="font-weight-bold">Urusan Utama</th>
    ...
    <div class="modal-dialog modal-lg" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Data Urusan Utama</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="nm_urusan_utama" class="control-label font-weight-bolder">Nama Urusan Utama <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nm_urusan_utama" id="nm_urusan_utama" placeholder="Nama Urusan Utama" value="<?php echo $this->input->post('nm_urusan_utama', TRUE); ?>" required>
                ...
                <div class="blockquote-footer">
                    <span><b>NB:</b> Wajib Mengisi Kolom Urusan Utama</span>
                </div>
            </div>
