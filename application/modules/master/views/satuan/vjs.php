...
<script type="text/javascript">
    ...
    getDataListindikator_satuan();

    function getDataListindikator_satuan() {
        $('#tblList').dataTable({
    ...
    $(document).on('click', '.btnEdit', function(e) {
        ...
        getDataindikator_satuan(token);
    });

    function getDataindikator_satuan(token) {
        run_waitMe($('#frmEntry'));
        $.ajax({
            type: 'POST',
            url: site + '/details',
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('#id_indikator').select2().val(data.message.id_indikator).trigger("change");
                    $('#nm_indikator_satuan').val(data.message.nm_indikator_satuan);
                    $('#bobot_satuan').val(data.message.bobot_satuan);
