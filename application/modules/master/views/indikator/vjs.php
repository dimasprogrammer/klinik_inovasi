...
<script type="text/javascript">
    ...
    getDataListIndikator();

    function getDataListIndikator() {
        $('#tblList').dataTable({
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('#informasi').val(data.message.informasi);
                    $('#bobot').val(data.message.bobot);
                    tinymce.get('data_pendukung').setContent(data.message.data_pendukung);
                    $('#jenis_file').val(data.message.jenis_file);
