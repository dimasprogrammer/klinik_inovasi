                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" class="font-weight-bold">Indikator</th>
                                    <th width="10%" class="font-weight-bold">Keterangan</th>
                                    <th width="10%" class="font-weight-bold">Informasi</th>
                                    <th width="10%" class="font-weight-bold">Bobot</th>
                                    <th width="10%" class="font-weight-bold">Data Pendukung</th>
                                    <th width="10%" class="font-weight-bold">Jenis File</th>
    ...
    <div class="modal-dialog modal-lg" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Data indikator</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="nm_indikator" class="control-label font-weight-bolder">Nama indikator <span class="text-danger">*</span></label>
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12">
                        ...
                        <textarea class="form-control" name="keterangan" id="keterangan" rows="3" placeholder="keterangan"><?php echo $this->input->post('keterangan', TRUE); ?></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="informasi" class="control-label font-weight-bolder">Informasi Indikator <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="informasi" id="informasi" placeholder="Informasi Indikator" value="<?php echo $this->input->post('informasi', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-6 required">
                        <label for="bobot" class="control-label font-weight-bolder">Bobot Indikator <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="bobot" id="bobot" placeholder="Bobot Indikator" value="<?php echo $this->input->post('bobot', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="data_pendukung" class="control-label font-weight-bolder">Data Pendukung <span class="text-danger">*</span></label>
                        <textarea class="form-control" name="data_pendukung" id="data_pendukung" rows="3" placeholder="Data Pendukung"><?php echo $this->input->post('data_pendukung', TRUE); ?></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="jenis_file" class="control-label font-weight-bolder">Jenis File <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="jenis_file" id="jenis_file" placeholder="Jenis File" value="<?php echo $this->input->post('jenis_file', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                ...
                <div class="blockquote-footer">
                    <span><b>NB:</b> <span><b>NB:</b> Wajib Mengisi Kolom indikator</span></span>
                </div>
            </div>
