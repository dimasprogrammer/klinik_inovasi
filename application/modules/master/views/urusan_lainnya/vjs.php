<script type="text/javascript">
    ...
    getDataListBentukInovasi();

    function getDataListBentukInovasi() {
        $('#tblList').dataTable({
    ...
    $(document).on('click', '.btnEdit', function(e) {
        ...
        getDataBentukInovasi(token);
    });

    function getDataBentukInovasi(token) {
        run_waitMe($('#frmEntry'));
        $.ajax({
            type: 'POST',
            url: site + '/details',
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('#nm_urusan_lainnya').val(data.message.nm_urusan_lainnya);
                    $('#deskripsi').val(data.message.deskripsi);
