                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" class="font-weight-bold">Bentuk Inovasi</th>
    ...
    <div class="modal-dialog modal-lg" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Data Bentuk Inovasi</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="nm_bentuk" class="control-label font-weight-bolder">Nama Bentuk Inovasi <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nm_bentuk" id="nm_bentuk" placeholder="Nama Bentuk Inovasi" value="<?php echo $this->input->post('nm_bentuk', TRUE); ?>" required>
