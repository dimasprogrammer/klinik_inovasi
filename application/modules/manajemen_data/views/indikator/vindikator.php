                    ...
                    <table class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="font-weight-bold" width="1%"><strong>:</strong></th>
                                <th class="font-weight-bold"><strong>
                ...
                <table class="table table-hover mb-0" width="100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="10%" class="font-weight-bold"><a>Pilih Parameter</i></a></th>
                    ...
                    <tbody>
                        ...
                        foreach ($list_indikator as $key => $list) :
                            ...
                            // $thumbanilCheck  = $checkDataLink->row_array()['thumbnail'];
                            // $tanggalCheck  = $checkDataLink->row_array()['create_date'];
                            // $year  = substr($tanggalCheck, 0, 4);
                            // $month = substr($tanggalCheck, 5, 2);
                            // if ($thumbanilCheck == '') {
                            //     $gambar = '';
                            // } else {
                            //     $gambar = '';
                            ...
                            if ($jenis_dokumen == 1) {
                                ...
                                if ($btnURL <= 0) {
                                    ...
                                    $year       = date('Y', strtotime($checkDataLink->row_array()['create_date']));
                                    $month      = date('m', strtotime($checkDataLink->row_array()['create_date']));
                                    $btnCheck = '<a class="btn btn-primary btn-sm px-2 py-1 mt-2 my-0 mx-0" target="_blank" href="' . $checkDataLink->row_array()['link_youtube'] . '">Lihat Youtube</a>
                                    <a class="btn btn-primary btn-sm px-2 py-1 mt-2 my-0 mx-0" target="_blank" href="' . base_url('dokumen/thumbnails/' . $year . '/' . $month . '/' . $checkDataLink->row_array()['thumbnail']) . '">Lihat Thumbnail</a>';
                            ...
                            $wajib = ($list->wajib_diisi == 'Y') ? '<span class="text-danger">Wajib Diisi</span>' : '';

                        ?>
                            <tr>
                                <td><?php echo $no_urut; ?></td>
                                <td><?php echo $list->nm_indikator; ?>
                                    <BR> Bobot: <b> <?php echo $list->bobot; ?></b>
                                    <BR> <?php echo $wajib; ?>
                                </td>
...
<div class="modal fade" id="modalEntryFormLink" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" id="frmEntryLink">
        <div class="modal-content">
            <div class="modal-header blue-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Video Pendukung</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    ...
                    <div class="col-12 col-md-6">
                        <label for="nama_thumbnail" class="control-label font-weight-bold">Thumbnails <span class="text-danger">*</span></label>
                        <div class="custom-file">
                            <input type="file" class="customFile" name="nama_thumbnail" id="nama_thumbnail" lang="in" value="<?= $this->input->post('nama_thumbnail', TRUE); ?>">
                            <label class="custom-file-label" for="nama_thumbnail"> </i>Silahkan Pilih File</label>
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
