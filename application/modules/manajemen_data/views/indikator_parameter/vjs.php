...
<script type="text/javascript">
    ...
    getDataListindikator_parameter();

    function getDataListindikator_parameter() {
        $('#tblList').dataTable({
    ...
    $(document).on('click', '.btnEdit', function(e) {
        ...
        getDataIndikatorParameter(token);
    });

    function getDataIndikatorParameter(token) {
        run_waitMe($('#frmEntry'));
        $.ajax({
            type: 'POST',
            url: site + '/details',
            ...
            success: function(data) {
                ...
                if (data.status == 'RC200') {
                    ...
                    $('#nm_indikator').val(data.message.nm_indikator);
                    $('#id_indikator_satuan').select2().val(data.message.id_indikator_satuan).trigger("change");
