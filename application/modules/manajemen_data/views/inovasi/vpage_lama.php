                                            ...
                                            <div class="table-responsive-md">
                                                <table cellspacing="0" class="table table-striped table-border table-hover table-sm" id="tblList" width="100%">
                                                    <thead>
                                                        ...
                                                        <th width="15%" class="font-weight-bold">Urusan Pemerintahan</th>
                                                        <th width="10%" class="font-weight-bold">Waktu Uji Coba</th>
                                                        <th width="11%" class="font-weight-bold">Tahapan Inovasi</th>
                                                        <th width="11%" class="font-weight-bold">Waktu Penerapan</th>
