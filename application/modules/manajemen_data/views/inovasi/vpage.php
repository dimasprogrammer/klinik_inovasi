            ...
            <div class="classic-tabs ">
                ...
                <div class="tabs-wrapper">
                    ...
                    <ul class="nav tabs-primary" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-light waves-effect waves-light" href="<?php echo site_url() . 'manajemen_data/inovasi/'; ?>"><i class="fas fa-table fa-1x"></i> SEMUA </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link waves-light waves-effect waves-light" href="<?php echo site_url() . 'manajemen_data/inovasi/index/1'; ?>"><i class="fas fa-table fa-1x"></i> INISIATIF </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link waves-light waves-effect waves-light" href="<?php echo site_url() . 'manajemen_data/inovasi/index/2'; ?>"><i class="fas fa-table fa-1x"></i> UJI COBA </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link waves-light waves-effect waves-light" href="<?php echo site_url() . 'manajemen_data/inovasi/index/3'; ?>"><i class="fas fa-table fa-1x"></i> PENERAPAN </a>
                        </li>
                                    ...
                                    <div class="card">
                                        <div class="card-header white-text text-left">
                                            ...
                                            ?>
                                                ...
                                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light px-3 py-2 font-weight-bold" name="printExcelAll" id="printExcelAll"><i class="far fa-file-excel"></i> cetak excel </button>
                                            <?php } ?>
                                        </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-row mb-3 getOpd">
                                                                <div class="col-12 col-md-6">
                                                                    ...
                                                                    echo form_dropdown('opd', isset($getInstansi) ? $getInstansi : array('' => 'Pilih Nama Instansi'), $this->input->post('opd', TRUE), 'class="form-control select-all" id="opd" style="width:100%"'); ?>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="col-12 col-md-12">
                                                                    <div class="d-flex justify-content-lg-start align-items-center" style="margin-right: -5px;">
                                                                        <button type="submit" class="btn btn-rounded btn-primary waves-effect waves-light px-3 py-2 font-weight-bold" name="filter" id="filter"><i class="fas fa-filter"></i> Pencarian</button>
                                                                        ...
                                                                        <button type="button" class="btn btn-success btn-rounded waves-effect waves-light px-3 py-2 font-weight-bold" name="printExcel" id="printExcel"><i class="far fa-file-excel"></i> Cetak Excel </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        ...
                        <textarea class="form-control" name="rancang_bangun" id="rancang_bangun" value="<?= $this->input->post('rancang_bangun', TRUE); ?>" rows="4"></textarea>
...
<!---------------------------- UPDATE NOMOR REGISTRASI KE BALITBANG PROVINSI ------------------------------------>
<div class="modal fade" id="modalEntryFormPermohonanUpdate" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" id="frmEntryPermohonanUpdate">
        <div class="modal-content">
            <div class="modal-header blue-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Update Permohonan Nomor Registrasi </h4>
                <button type="button" class="close btnClosePermohonanUpdate" aria-label="Close">
                    <span aria-hidden="true" class="white-text">&times;</span>
                </button>
            </div>
            <?php echo form_open_multipart(site_url(isset($siteUri) ? $siteUri . '/updatePermohonan' : ''), array('id' => 'formEntryPermohonanUpdate', 'class=' => 'needs-validated', 'novalidate' => '')); ?>
            <div class="modal-body">
                <div id="errEntryPermohonanUpdate"></div>
                <?php echo form_hidden('tokenId', ''); ?>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required"><label for="nomor_surat" class="control-label font-weight-bold">Apakah Anda yakin mengirimkan Inovasi Daerah Ke Balitbang Provinsi <span class="text-danger">?</span></label>
                    </div>
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="nama_lengkap_update" class="control-label font-weight-bolder">Nama Lengkap</label>
                        <input type="text" class="form-control" name="nama_lengkap_update" id="nama_lengkap_update" placeholder="Nama Lengkap" value="<?php echo $this->input->post('nama_lengkap_update', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="jabatan_update" class="control-label font-weight-bolder">Jabatan / Golongan</label>
                        <input type="text" class="form-control" name="jabatan_update" id="jabatan_update" placeholder="Jabatan / Golongan" value="<?php echo $this->input->post('jabatan_update', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="instansi_update" class="control-label font-weight-bolder">Instansi</label>
                        <input type="text" class="form-control" name="instansi_update" id="instansi_update" placeholder="Instansi" value="<?php echo $this->input->post('instansi_update', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="no_hp_update" class="control-label font-weight-bolder">No. HP</label>
                        <input type="text" class="form-control" name="no_hp_update" id="no_hp_update" placeholder="No. HP" value="<?php echo $this->input->post('no_hp_update', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <label for="email_update" class="control-label font-weight-bolder">E-mail</label>
                        <input type="email_update" class="form-control" name="email_update" id="email_update" placeholder="E-mail" value="<?php echo $this->input->post('email_update', TRUE); ?>" required>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <label for="menyatakan" class="control-label font-weight-bold">Menyatakan bahwa saya akan melaksanakan ketentuan sebagai berikut:</label>
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-12 required">
                        <input class="form-check-input" type="checkbox" value="1" id="status_permohonan_update" name="status_permohonan_update" />
                        <label class="form-check-label font-weight-bolder text-left" for="status_permohonan_update"> Saya menyatakan bahwa data pernyataan yang diinputkan diatas sudah benar</label>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="blockquote-footer">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger waves-effect waves-light px-3 py-2 font-weight-bold btnClosePermohonanUpdate"><i class="fas fa-times"></i> Batalkan Permohonan </button>
                <button type="submit" class="btn btn-primary waves-effect waves-light px-3 py-2 font-weight-bold" name="savePermohonanUpdate" id="savePermohonanUpdate"><i class="fas fa-check"></i> Kirim Ke Balitbang </button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
